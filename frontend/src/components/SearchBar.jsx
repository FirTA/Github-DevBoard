...
function SearchBar({ onSearch, setUser }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const searchUsername = e.target.elements[0].value;
  ...
  return (
    <form className="relative flex items-center" ref={dropdownRef}>
      <div className="relative flex-grow">
        <input
          ...
          className="w-full py-2 px-4 pr-10 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 border-0 text-gray-800"
        />
